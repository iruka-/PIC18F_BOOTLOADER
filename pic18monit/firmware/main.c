...
//	選択スイッチ.
//---------------------------------------------------------------------
#define	TIMER2_INTERRUPT	1		// タイマー２割り込みを使用する.
...
//	timer2_init(0x80 |(15<<3)| 2,255);	// 割り込みON,postscale 1/16,prescale 1/16,1/256 = 183.10 Hz
...
//	timer2_init(0x80 |(14<<3)| 1,  4);	// 割り込みON,postscale 1/15,prescale 1/16,1/5  =  40kHz
