...
rom USB_DEV_DSC device_dsc=
{
    ...
    0x03,  // 0x00             Device serial number string index @@@
...
sizeof(sd001),DSC_STR,'A','V','R','e','t','c'};

rom struct{byte bLength;byte bDscType;word string[8];}sd002={
sizeof(sd002),DSC_STR,'P','I','C','1','8','s','p','x'};

#if RAM_SERIAL
ram struct{byte bLength;byte bDscType;word string[4];}sd003={
sizeof(sd003),DSC_STR,'0','0','0','1'};
#else
...
#if RAM_SERIAL
    (ram const unsigned char *ram)&sd003
#else
